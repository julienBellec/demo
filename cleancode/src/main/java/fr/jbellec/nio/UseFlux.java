...
public class UseFlux {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (BufferedReader reader2 = Files.newBufferedReader(source);
             BufferedWriter writer2 = new BufferedWriter(stringWriter);) {
    ...
    public static void copyUpperCase(Path source, Path dest) throws IOException {
        try (BufferedReader reader = Files.newBufferedReader(source);
             Writer writer = Files.newBufferedWriter(dest)) {
            String line;
